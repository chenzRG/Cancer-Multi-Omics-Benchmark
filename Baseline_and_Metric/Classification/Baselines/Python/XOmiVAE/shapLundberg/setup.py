...
def run_setup(with_binary=True, test_xgboost=True, test_lightgbm=True, test_catboost=True, test_spark=True):
    ...
    if with_binary:
        ...
        ext_modules.append(
            Extension('shapLundberg._cext', sources=['shapLundberg/_cext.cc'], extra_compile_args=compile_args)
        )
    ...
    setup(
        ...
        license='MIT',
        packages=[
            'shapLundberg', 'shapLundberg.explainers', 'shapLundberg.explainers.other', 'shapLundberg.explainers.deep',
            'shapLundberg.plots', 'shapLundberg.benchmark'
        ],
        package_data={'shapLundberg': ['plots/resources/*', 'tree_shap.h']},
